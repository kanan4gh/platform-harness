...
| `kanan4gh/outfit-studio` | https://github.com/kanan4gh/outfit-studio | PR #26で`AGENTS.md`とClaude Code / Codex / Kiroの3ハーネス構成へ移行済み | `current-neutral` | `direct-sync` | P0 | `synced` | `v1.3.0 / bd2cd8c` | 2026-07-15 | 通常checkoutの未追跡hooks・coverage・Playwright等は残存。次回もclean clone / worktreeを使用 | PR #22は不要としてcloseし、PR #26で同期完了。次回はユーザー指定時に新しいplatform-harness releaseとの差分をdirect-sync |
